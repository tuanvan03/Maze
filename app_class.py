...
class App:
    def __init__(self):
        ...
        self.bfs_button = Buttons(self, WHITE, 228, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Breadth-First')
        self.dfs_button = Buttons(self, WHITE, 448, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Depth-First')
        self.astar_button = Buttons(self, WHITE, 668, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'A-Star')
        self.dijkstra_button = Buttons(self, WHITE, 888, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Dijkstra')
        self.bidirectional_button = Buttons(self, WHITE, 1108, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Bidirectional')
        ...
        self.insert_image_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT + BUTTON_SPACER, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Insert Image')
        self.ca_hai_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 2 + BUTTON_SPACER * 2, 24, 24, '')
        self.ground_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 3 + BUTTON_SPACER * 3 - 24, 24, 24, '')
        self.water_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 4 + BUTTON_SPACER * 4 - 24*2, 24, 24, '')
        self.insert_maze_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 4 + BUTTON_SPACER * 4, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Insert Maze')
        self.wall_node_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 5 + BUTTON_SPACER * 5, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Wall Node')
        self.start_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT*6 + BUTTON_SPACER*6, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Visualize Path')
        self.reset_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT*7 + BUTTON_SPACER*7, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Reset')
        self.maze_generate_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 8 + BUTTON_SPACER * 8, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Generate Maze')
        self.main_menu_button = Buttons(self, AQUAMARINE, 20, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 9 + BUTTON_SPACER * 9, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Main Menu')
...
##### Function for the buttons on grid window. Became too repetitive so, I made it a function.
    ...
    def grid_window_buttons(self, pos, event):
        ...
        if event.type == pygame.MOUSEMOTION:
            if self.start_end_node_button.isOver(pos):
                ...
                self.start_button.colour, self.main_menu_button.colour, self.maze_generate_button.colour, self.insert_image_button.colour, \
                self.ca_hai_button.colour, self.water_button.colour, self.ground_button.colour, self.insert_maze_button.colour = \
                    STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE, STEELBLUE
    ...
    def insert(self):
        ...
        for x in range(104):
            pygame.draw.line(self.screen, ALICE, (GS_X + x * 12, GS_Y), (GS_X + x * 12, GE_Y))
        for y in range(60):
            pygame.draw.line(self.screen, ALICE, (GS_X, GS_Y + y * 12), (GE_X, GS_Y + y * 12))
    ...
    def draw(self, pos, colour):
        i, j = pos
        pygame.draw.rect(self.screen, colour, (i * 12 + 240+24, j * 12+24, 12, 12), 0)
...
##### MAIN MENU FUNCTIONS
    ...
    def main_menu_events(self):
        ...
        self.draw_text('Doan Van Tuan - 21000523', self.screen, [1100, 630], 25, WHITE, FONT, centered=False)
        self.draw_text('Pham Hoai Nam - 21000394', self.screen, [1100, 660], 25, WHITE, FONT, centered=False)
        self.draw_text('Do Van Thuan - 21001590', self.screen, [1100, 690], 25, WHITE, FONT, centered=False)
...
##### PLAYING STATE FUNCTIONS #####
    ...
    def grid_events(self):
        ...
        self.draw_text('Amphibious', self.screen, [60, 24 * 7 - 8], 20, BLACK, FONT, centered=False)
        self.draw_text('Ground', self.screen, [60, 24 * 9 - 8], 20, BLACK, FONT, centered=False)
        self.draw_text('Water', self.screen, [60, 24 * 11 - 8], 20, BLACK, FONT, centered=False)
        pygame.display.update()
            ...
            if pos[0] > 264 and pos[0] < 1512 and pos[1] > 24 and pos[1] < 744:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if self.state == 'draw S/E' and self.start_end_checker < 2:
                        ...
                        if self.start_end_checker == 0 and (x_grid_pos+2, y_grid_pos+2) not in self.wall_pos:
                            node_colour = TOMATO
                        ...
                        elif self.start_end_checker == 1 and (x_grid_pos+2, y_grid_pos+2) != (self.start_node_x, self.start_node_y) and (x_grid_pos+2, y_grid_pos+2) not in self.wall_pos:
                        ...
                        # Draw point on Grid
                        pygame.draw.rect(self.screen, node_colour, (264 + x_grid_pos * 12, 24 + y_grid_pos * 12, 12, 12), 0)
                ...
                if self.mouse_drag == 1:
                    ...
                    if self.state == 'draw walls':
                        if (x_grid_pos + 2, y_grid_pos + 2) not in self.wall_pos \
                                and (x_grid_pos + 2, y_grid_pos + 2) != (self.start_node_x, self.start_node_y) \
                                and (x_grid_pos + 2, y_grid_pos + 2) != (self.end_node_x, self.end_node_y):
                            pygame.draw.rect(self.screen, BLACK, (264 + x_grid_pos * 12, 24 + y_grid_pos * 12, 12, 12), 0)
